...
namespace AlgeTiles
{
	public class CustomEquationDialog : DialogFragment
	{
		...
		public static CustomEquationDialog NewInstance()
		{
			var dialogFragment = new CustomEquationDialog();
		...
		public override Dialog OnCreateDialog(Bundle savedInstanceState)
		{
			...
			var dialogView = inflater.Inflate(Resource.Layout.CustomQuestion, null);
