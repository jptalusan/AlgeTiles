...
namespace AlgeTiles
{
	...
	public class MainActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
			...
			var upperLeft = FindViewById<FrameLayout>(Resource.Id.upperLeft);
			var upperRight = FindViewById<FrameLayout>(Resource.Id.upperRight);
			var lowerLeft = FindViewById<FrameLayout>(Resource.Id.lowerLeft);
			var lowerRight = FindViewById<FrameLayout>(Resource.Id.lowerRight);
